...
public sealed class OutboxPublisherWorker : BackgroundService
{
    ...
    {
        _log.LogInformation("OutboxPublisherWorker started.");
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            try
            {
                ...
                foreach (var msg in batch)
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        _log.LogError(ex, "Failed to publish outbox message {Id} (attempt {Attempt})", msg.Id, msg.AttemptCount);
                    }
                }
            ...
            {
                _log.LogError(ex, "OutboxPublisherWorker loop error.");
